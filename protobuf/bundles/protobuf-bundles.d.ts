...
declare namespace awesomepackage {
    ...
    /** Represents a ZZ. */
    class ZZ implements IZZ {

        /**
         * Constructs a new ZZ.
         * @param [properties] Properties to set
         */
        constructor(properties?: awesomepackage.IZZ);
         ...
         * @returns ZZ instance
         */
        public static create(properties?: awesomepackage.IZZ): awesomepackage.ZZ;

        /**
         * Encodes the specified ZZ message. Does not implicitly {@link awesomepackage.ZZ.verify|verify} messages.
         * @param message ZZ message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: awesomepackage.IZZ, writer?: protobuf.Writer): protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: awesomepackage.IZZ, writer?: protobuf.Writer): protobuf.Writer;
         ...
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: (protobuf.Reader|Uint8Array), length?: number): awesomepackage.ZZ;
         ...
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: (protobuf.Reader|Uint8Array)): awesomepackage.ZZ;
         ...
         * @returns ZZ
         */
        public static fromObject(object: { [k: string]: any }): awesomepackage.ZZ;
         ...
         * @returns Plain object
         */
        public static toObject(message: awesomepackage.ZZ, options?: protobuf.IConversionOptions): { [k: string]: any };
